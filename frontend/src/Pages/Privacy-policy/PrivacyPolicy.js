    ...
    return (
        <div className="center">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Recipe Builder, Earth.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Recipe Builder, accessible from <Link to="/recipe" target="_blank">www.recipebuilder.com/recipe</Link></p>
                </li>
                <li>
            ...
            <ul>
                <li>By visiting this page on our <Link to="/recipe/about-us">About Us page</Link></li>
            </ul>
        </div >
    );
}
